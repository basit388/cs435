...
Use this thread to create a worker thread.
Both the master and the worker thread accomplish the task.
The master thread accumulates and returns the result.
We observe that the total number of threads has decreased.
